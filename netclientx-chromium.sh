...
apt update && apt upgrade -y && apt autoremove -y && apt install -y --no-install-recommends xorg openbox chromium-browser network-manager network-manager-gnome tint2 wget
